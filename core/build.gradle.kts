...
android {
    ...
    productFlavors {
        create("production") {
            ...
            buildConfigField(
                "String",
                "BASE_URL_YOUTUBE_PLAY",
                "\"https://www.youtube.com/watch?v=\""
            )
            buildConfigField(
                "String",
                "AUTH_TOKEN",
                "\"eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4Y2ZiZDY4NDc2MDNhMzk3M2M1MTdlNTc2MDdjMjRjYiIsInN1YiI6IjVhZjQwMTllOTI1MTQxNzkwZjAwNWYyYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.KIG2BAaY8F_N7Ha-bqU5kg7AKDX6qf6pjBuYMEd6104\""
            )
