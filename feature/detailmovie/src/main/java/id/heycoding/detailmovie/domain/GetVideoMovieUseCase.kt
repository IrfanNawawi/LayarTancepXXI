 ...
 * heycoding@gmail.com
 */
class GetVideoMovieUseCase(private val repository: DetailMovieRepository, dispatcher: CoroutineDispatcher): BaseUseCase<GetVideoMovieUseCase.Param, List<VideoViewParam>>(dispatcher) {
